...
<a name="activateuserusingget"></a>
#### activateUser
```
GET /home/activeuser/email
```
...
|类型|名称|说明|类型|
|---|---|---|---|
|**Body**|**email**  <br>*可选*|email|string|
|**Body**|**sid**  <br>*可选*|sid|string|
...
<a name="registerbyemailusingpost"></a>
#### registerByEmail
```
...
<a name="setpasswordusingpost"></a>
#### setPassword
```
POST /home/user/password
```
